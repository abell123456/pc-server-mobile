...
var PATTERN_BLANK = /\s/,
	...
	PATTERN_OPERATOR = /^(?:delete|typeof|void|instanceof|new|in|return|case|throw)$/,

	/**
	 * Remove comments from JS or CSS.
	 * Based on http://james.padolsey.com/javascript/removing-comments-in-javascript/
	 * @param str {string}
	 * @param isJS {boolean}
	 * @return {string}
	 */
	removeComments = function (str, isJS) {
		str = str.split('');
		isJS = !!isJS;
...
module.exports = function (config) {
	...
	return function (context, next) {
		var file = context.file,
			isJS = path.extname(file.pathname) === '.js';

		file.data = removeComments(file.data, isJS);
